...
const personalNav = [
  { href: "/inbox", label: "COMMS", icon: Inbox },
  { href: "/my-issues", label: "My Fronts", icon: CircleUser },
];

const workspaceNav = [
  { href: "/issues", label: "Missions", icon: ListTodo },
  { href: "/projects", label: "Campaigns", icon: FolderKanban },
  { href: "/autopilots", label: "Autopilot", icon: Zap },
  { href: "/agents", label: "Battalion", icon: Bot },
];

const configureNav = [
  { href: "/runtimes", label: "Bases", icon: Monitor },
  { href: "/skills", label: "Doctrines", icon: BookOpenText },
                  ...
                  return (
                    <SidebarMenuItem key={item.href}>
                      ...
                      >
                        ...
                        {item.label === "COMMS" && unreadCount > 0 && (
                  ...
                  return (
                    <SidebarMenuItem key={item.href}>
                      ...
                      >
                        <item.icon />
                        <span>{item.label}</span>
                        {item.label === "Bases" && hasRuntimeUpdates && (
