  ...
  return (
    <div className="flex flex-1 min-h-0 flex-col">
      ...
      <PageHeader className="gap-1.5">
        ...
        <span className="text-sm font-medium">My Fronts</span>
      </PageHeader>
      ...
      <ViewStoreProvider store={myIssuesViewStore}>
        {myIssues.length === 0 ? (
          <div className="flex flex-1 min-h-0 flex-col items-center justify-center gap-2 text-muted-foreground">
            ...
            <p className="text-sm">No missions assigned to you</p>
            <p className="text-xs">Missions you create or are assigned to will appear here.</p>
          </div>
        ) : (
