...
import { BOPE_MISSION_BRIEF } from "../issues/bope-mission-template";
        ...
        toast.custom((t) => (
          <div className="bg-popover text-popover-foreground border rounded-lg shadow-lg p-4 w-[360px]">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium">Mission created</span>
            </div>
          ...
          <>
            ...
            <div className="flex items-center justify-between px-5 pt-3 pb-2 shrink-0">
              <div className="flex items-center gap-1.5 text-xs">
                ...
                <span className="font-medium">{data?.parent_issue_id ? "New sub-mission" : "New mission"}</span>
              </div>
            ...
            <div {...descDropZoneProps} className="relative flex-1 min-h-0 overflow-y-auto px-5">
              <ContentEditor
                ref={descEditorRef}
                defaultValue={draft.description || (!data?.parent_issue_id ? BOPE_MISSION_BRIEF : "")}
